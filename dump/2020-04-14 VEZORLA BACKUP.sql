...
INSERT INTO `account_discount` VALUES ('jocelyn@email.ca','FIRST'),('johnathon@email.ca','FIRST'),('matthew@email.ca','FIRST');
...
INSERT INTO `cart` VALUES (1,_binary '','admin@email.ca'),(2,_binary '','matthew@email.ca'),(3,_binary '','jocelyn@email.ca'),(4,_binary '','carlos@email.ca'),(5,_binary '','minh@email.ca'),(6,_binary '','aaron@email.ca'),(7,_binary '\0',NULL),(8,_binary '','jocelyn@email.ca'),(9,_binary '','jocelyn@email.ca'),(10,_binary '\0',NULL),(11,_binary '','matthew@email.ca'),(12,_binary '\0',NULL),(13,_binary '','ml@email.ca'),(14,_binary '','ml@email.ca');
...
INSERT INTO `invoice` VALUES (1,'2020-04-09',7132,_binary '',_binary '\0',0,64193,3209,67402,'johnathon@email.ca'),(2,'2020-04-09',19500,_binary '\0',_binary '\0',1000,175500,8775,185275,'jocelyn@email.ca'),(3,'2020-04-09',0,_binary '\0',_binary '\0',1000,15000,750,16750,'jocelyn@email.ca'),(4,'2020-04-14',13350,_binary '\0',_binary '\0',1000,120150,6007,127157,'matthew@email.ca'),(5,'2020-04-14',0,_binary '\0',_binary '\0',1000,30000,1500,32500,'ml@email.ca'),(6,'2020-04-14',0,_binary '\0',_binary '\0',1000,15000,750,16750,'ml@email.ca');
...
INSERT INTO `line_item` VALUES (1,'Extra Virgin Olive Oil ',15000,2,7,1,NULL,1),(2,'ORIGINAL Dark Chocolate',13775,3,7,1,NULL,5),(3,'Extra Virgin Olive Oil PICUAL',19500,10,3,2,NULL,4),(4,'Extra Virgin Olive Oil ',15000,1,8,3,NULL,1),(5,'Extra Virgin Olive Oil ',15000,5,10,4,NULL,1),(6,'Extra Virgin Olive Oil ROYAL',29250,2,10,4,NULL,2),(7,'Extra Virgin Olive Oil ',15000,2,12,5,NULL,1),(8,'Extra Virgin Olive Oil ',15000,1,13,6,NULL,1);
...
INSERT INTO `lot` VALUES ('1-1','2020-04-09',5000,89,1,1,1),('2-1','2020-04-09',2000,18,2,2,2),('3-1','2020-04-09',9000,0,4,3,1),('4-1','2020-04-09',3000,57,5,4,1);
...
-- Dump completed on 2020-04-14  8:51:52
